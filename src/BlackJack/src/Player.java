...
public class Player {
   ...
   */
	...
	/**
	 * The card's in the player's current hand.
	 */
	private Card[] hand = new Card[10];
	
	/**
	 * The number of card's in the player's current hand.
	 */
	...
	/**
	 * Reset's the player's hand to empty.
	 */
	...
	public boolean addCard(Card aCard) {
		// print error if we already has max number of cards
		if(this.numCards == 10) {
	...
	public int getHandSum() {
		...
		// if we have aces and sum is > 21, set some/all of them to value 1 instead.
